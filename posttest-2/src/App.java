    ...
    static void display_data() {
        ...
        if (DataKomik.size() == 0) {
            ...
            for(int i = 0; i < DataKomik.size(); i++) {
                ...
                DataKomik.get(i).getJdl();
                DataKomik.get(i).getGenre();
                DataKomik.get(i).getThn();
                DataKomik.get(i).getJml();
                System.out.println("\n");
            }
        }
    }
            ...
            if (DataKomik.size() == 0) {
                ...
                if (isNum(pil_ubah_String)) {
                    ...
                    if (pil_ubah <= 0 || pil_ubah > DataKomik.size()) {
                        ...
                        DataKomik.get(pil_ubah-1).getJdl();
                        DataKomik.get(pil_ubah-1).getGenre();
                        DataKomik.get(pil_ubah-1).getThn();
                        DataKomik.get(pil_ubah-1).getJml();
                        boolean back = true;
                        while (back) {
            ...
            if (DataKomik.size() == 0) {
                ...
                if (isNum(pil_hapus_String)) {
                    ...
                    if (pil_hapus <= 0 || pil_hapus > DataKomik.size()) {
                        ...
                        DataKomik.get(pil_hapus-1).getJdl();
                        DataKomik.get(pil_hapus-1).getGenre();
                        DataKomik.get(pil_hapus-1).getThn();
                        DataKomik.get(pil_hapus-1).getJml();
                        boolean loop = true;
                        while (loop) {
