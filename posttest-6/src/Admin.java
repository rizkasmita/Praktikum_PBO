...
public final class Admin extends User implements Modify {
    private ArrayList<Komik> DataKomik;
    private ArrayList<Member> DataMember;
    private final String lvl = "Admin";

    public Admin(String usn, String pw, String name, ArrayList<Member> data, ArrayList<Komik> datkom) {
        super(usn, pw, name);
    ...
    @Override
    protected final void menu() throws IOException, InterruptedException {
        while(true) {
            greeting();
